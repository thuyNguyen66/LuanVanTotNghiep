			...
			<li class="">
				<div class="collapsible-header" id="menu"><i class="material-icons hide" id="menu-arrow-down">arrow_drop_down</i>
					...
					<div class="collapsible-body list">
						...
						<a href="index.php?action=show_subject_head_panel" class="menu-list cursor">Quản Lý Trưởng bộ môn</a>
						<a href="index.php?action=show_teachers_panel" class="menu-list cursor">Quản Lý Giáo Viên</a>
						...
						<a href="index.php?action=show_statistic_panel" class="menu-list cursor">Thống kê</a>
					</div>
				</li>
